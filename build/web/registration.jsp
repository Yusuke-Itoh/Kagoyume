<%-- 
    ...
    Created on : 2016/07/28, 14:20:46
    Author     : maimaimai
--%>
...
<html>
    ...
    <body>
        <form action="RegistrationConfirm" method="POST">
            ...
            <label for="mailaddress">メールアドレス</label><input id="mailaddress" name="mailaddress" value="<% if(reinput){out.print(ud.getMailaddress());}%>"><br />
            <label for="address">住所</label><input id="address" name="address" value="<% if(reinput){out.print(ud.getAddress());}%>"><br />
        <br>
